...
<script>
  ...
  function createMap() {
    ...
    // Add search control
    if (window.L.Control.Search) {
      const searchControl = new window.L.Control.Search({
  ...
  async function reverseGeocode(latitude, longitude) {
    try {
      ...
      if (data.address) {
        ...
        // Update property fields with geocoded data
  ...
  <div class="px-4 py-5 sm:p-6">
    ...
    {#if activeTab === 'location'}
      <div class="space-y-6">
          ...
          {#if locationSuccess}
            ...
            {#if geocodeResult}
              <div class="mt-2 text-sm text-gray-700 dark:text-gray-300">
                <p class="font-medium">{$t('property.detectedAddress')}:</p>
        ...
        <div class="h-80 bg-gray-100 dark:bg-gray-800 rounded-md overflow-hidden">
    ...
    {#if activeTab === 'rooms'}
      <div class="space-y-6">
        ...
        <div class="bg-gray-50 dark:bg-gray-700 p-6 rounded-md">
          <h4 class="text-md font-medium text-gray-900 dark:text-white mb-4">{$t('property.addRoom')}</h4>
        ...
        {#if rooms.length > 0}
          <div>
            <h4 class="text-md font-medium text-gray-900 dark:text-white mb-4">{$t('property.roomList')}</h4>
